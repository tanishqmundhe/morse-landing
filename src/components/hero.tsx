  ...
  return (
    <section className="p-2.5 sm:p-3.5">
      <div className="on-stage relative isolate flex min-h-[640px] flex-col overflow-hidden rounded-[22px] bg-stage sm:rounded-[30px] lg:h-[calc(100svh-28px)] lg:max-h-[940px]">
        ...
        <div
          aria-hidden="true"
          className="absolute inset-0 -z-10 bg-[linear-gradient(90deg,oklch(0.205_0_0/0.9)_0%,oklch(0.205_0_0/0.68)_46%,oklch(0.205_0_0/0.26)_74%,transparent_92%),linear-gradient(0deg,oklch(0.205_0_0/0.66)_0%,transparent_44%)]"
        />
