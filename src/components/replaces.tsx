...
function Cell({ brand }: { brand: { name: string; path: string } }) {
  return (
    <div className="flex h-[108px] w-[200px] shrink-0 items-center justify-center gap-2.5 overflow-clip border-r border-hairline px-4 text-ink-faint lg:h-[132px]">
      {MARKS && (
